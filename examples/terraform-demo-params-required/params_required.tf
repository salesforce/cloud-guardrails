locals {
  ...
  policy_ids_example_PR_Audit = [
    ...
    # Data Factory
    # -----------------------------------------------------------------------------------------------------------------
    "6809a3d0-d354-42fb-b955-783d207c62a8", # Azure Data Factory linked service resource type should be in allow list 
    ...
    # Key Vault
    # -----------------------------------------------------------------------------------------------------------------
    "a22f4a40-01d3-4c7d-8071-da157eeff341", # Certificates should be issued by the specified non-integrated certificate authority 
    "12ef42cb-9903-4e39-9c26-422d29570417", # Certificates should have the specified lifetime action triggers 
    "f772fb64-8e40-40ad-87bc-7706e1949427", # Certificates should not expire within the specified number of days 
    "cee51871-e572-4576-855c-047c820360f0", # Certificates using RSA cryptography should have the specified minimum key size 
    "5ff38825-c5d8-47c5-b70e-069a21955146", # Keys should have more than the specified number of days before expiration 
    "49a22571-d204-4c91-a7b6-09b1a586fbc9", # Keys should have the specified maximum validity period 
    "c26e4b24-cf98-4c67-b48b-5a25c4c69eb9", # Keys should not be active for longer than the specified number of days 
    "82067dbb-e53b-4e06-b631-546d197452d9", # Keys using RSA cryptography should have a specified minimum key size 
    "b0eb591a-5e70-4534-a8bf-04b9c489584a", # Secrets should have more than the specified number of days before expiration 
    "342e8053-e12e-4c44-be01-c3c2f318400f", # Secrets should have the specified maximum validity period 
    "e8d99835-8a06-45ae-a8e0-87a91941ccfe", # Secrets should not be active for longer than the specified number of days 
    ...
    # Machine Learning
    # -----------------------------------------------------------------------------------------------------------------
    "77eeea86-7e81-4a7d-9067-de844d096752", # Configure allowed Python packages for specified Azure Machine Learning computes 
    "53c70b02-63dd-11ea-bc55-0242ac130003", # Configure allowed module authors for specified Azure Machine Learning computes 
    "5853517a-63de-11ea-bc55-0242ac130003", # Configure allowed registries for specified Azure Machine Learning computes 
    "3948394e-63de-11ea-bc55-0242ac130003", # Configure an approval endpoint called prior to jobs running for specified Azure Machine Learning computes 
    "6a6f7384-63de-11ea-bc55-0242ac130003", # Configure code signing for training code for specified Azure Machine Learning computes 
  ...
  policy_definition_map = {
    ...
    "Azure Data Factory linked service resource type should be in allow list" = "/providers/Microsoft.Authorization/policyDefinitions/6809a3d0-d354-42fb-b955-783d207c62a8",
    ...
    "Certificates should be issued by the specified non-integrated certificate authority" = "/providers/Microsoft.Authorization/policyDefinitions/a22f4a40-01d3-4c7d-8071-da157eeff341",
    "Certificates should have the specified lifetime action triggers" = "/providers/Microsoft.Authorization/policyDefinitions/12ef42cb-9903-4e39-9c26-422d29570417",
    "Certificates should not expire within the specified number of days" = "/providers/Microsoft.Authorization/policyDefinitions/f772fb64-8e40-40ad-87bc-7706e1949427",
    "Certificates using RSA cryptography should have the specified minimum key size" = "/providers/Microsoft.Authorization/policyDefinitions/cee51871-e572-4576-855c-047c820360f0",
    "Keys should have more than the specified number of days before expiration" = "/providers/Microsoft.Authorization/policyDefinitions/5ff38825-c5d8-47c5-b70e-069a21955146",
    "Keys should have the specified maximum validity period" = "/providers/Microsoft.Authorization/policyDefinitions/49a22571-d204-4c91-a7b6-09b1a586fbc9",
    "Keys should not be active for longer than the specified number of days" = "/providers/Microsoft.Authorization/policyDefinitions/c26e4b24-cf98-4c67-b48b-5a25c4c69eb9",
    "Keys using RSA cryptography should have a specified minimum key size" = "/providers/Microsoft.Authorization/policyDefinitions/82067dbb-e53b-4e06-b631-546d197452d9",
    "Secrets should have more than the specified number of days before expiration" = "/providers/Microsoft.Authorization/policyDefinitions/b0eb591a-5e70-4534-a8bf-04b9c489584a",
    "Secrets should have the specified maximum validity period" = "/providers/Microsoft.Authorization/policyDefinitions/342e8053-e12e-4c44-be01-c3c2f318400f",
    "Secrets should not be active for longer than the specified number of days" = "/providers/Microsoft.Authorization/policyDefinitions/e8d99835-8a06-45ae-a8e0-87a91941ccfe",
    ...
    "Configure allowed registries for specified Azure Machine Learning computes" = "/providers/Microsoft.Authorization/policyDefinitions/5853517a-63de-11ea-bc55-0242ac130003",
...
resource "azurerm_policy_set_definition" "example_PR_Audit" {
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Azure Data Factory linked service resource type should be in allow list")
    parameter_values = jsonencode({
        effect = { "value" : "Audit" }
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Certificates should be issued by the specified non-integrated certificate authority")
    parameter_values = jsonencode({
        caCommonName = { "value" : "" }
        effect = { "value" : "audit" }
    })
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Certificates should have the specified lifetime action triggers")
    parameter_values = jsonencode({
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Certificates should not expire within the specified number of days")
    parameter_values = jsonencode({
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Certificates using RSA cryptography should have the specified minimum key size")
    parameter_values = jsonencode({
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Keys should have more than the specified number of days before expiration")
    parameter_values = jsonencode({
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Keys should have the specified maximum validity period")
    parameter_values = jsonencode({
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Keys should not be active for longer than the specified number of days")
    parameter_values = jsonencode({
        maximumValidityInDays = { "value" : 0 }
        effect = { "value" : "Audit" }
    })
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Keys using RSA cryptography should have a specified minimum key size")
    parameter_values = jsonencode({
        minimumRSAKeySize = { "value" : 0 }
        effect = { "value" : "Audit" }
    })
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Secrets should have more than the specified number of days before expiration")
    parameter_values = jsonencode({
        minimumDaysBeforeExpiration = { "value" : 0 }
        effect = { "value" : "Audit" }
    })
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Secrets should have the specified maximum validity period")
    parameter_values = jsonencode({
        maximumValidityInDays = { "value" : 0 }
        effect = { "value" : "Audit" }
    })
  ...
  policy_definition_reference {
    policy_definition_id = lookup(local.policy_definition_map, "Secrets should not be active for longer than the specified number of days")
    parameter_values = jsonencode({
        maximumValidityInDays = { "value" : 0 }
        effect = { "value" : "Audit" }
    })
