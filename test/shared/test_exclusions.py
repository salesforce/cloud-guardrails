...
from azure_guardrails.shared.exclusions import get_new_exclusions_template, Exclusions, get_exclusions_from_file
...
class ExclusionsTestCase(unittest.TestCase):
    def test_default_exclusions_template(self):
        result = get_new_exclusions_template()
        print(result)
    ...
    def test_read_exclusions(self):
        default_exclusions = get_new_exclusions_template()
